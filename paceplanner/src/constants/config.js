...
/** Kolekcja tras i ID aktywnej trasy */
export const ROUTES_STORAGE_KEY = 'pacePlannerRoutesV1';     // tablica tras
export const ACTIVE_ROUTE_ID_KEY = 'pacePlannerActiveRouteIdV1';